...
<div class="p">
    ...
    echo "<p style=' margin-top: 70px;font-size:30px;margin-left:400px;color:white;background-color:black;width:400px;height:50px;text-align:center;'>Buy Design </p>" ;
    $sql = "SELECT * FROM sell1 where product_type='design'";
    if($result = $mysqli->query($sql)){
        ...
        if($result->num_rows > 0){
           ...
           while($row = $result->fetch_array()){
               echo "<form style='margin-left:400px;background-color:green;color:white;width:400px;height:410px;'action='designbuy.php'method='post'>";
