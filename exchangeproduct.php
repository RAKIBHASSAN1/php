<?php	
	...
	if(isset($_POST['save'])){
        ...
        $d=$_POST['email'];
        $mysqli->query("INSERT INTO exchange(name,address,phone_number,email)VALUES('$a','$b','$c','$d')");
        header('location:exchangeproduct1.php');
    }
    $mysqli->close();
    ?>
...
<html> 
    <head>
            <link href="styles/exchangeproduct.css" rel="stylesheet" type="text/css">
    </head>
<body> 

    <form action="exchangeproduct.php" method="post">
    <P>Product Exchanger Information</p>
    <div class="n1">
