...
<html>
    <head>
    <link href="styles/moneycalculature.css" rel="stylesheet">
    </head>
    <body>
        <div class="raq">
        ...
        <select id="operators">
            ...
            <option value="Bajan dollar">Bajan dollar</option>
            <option value="Belarusian Ruble">Belarusian Ruble</option>
            <option value="Belize Dollar">Belize Dollar</option>
            <option value="Bitcoin">Bitcoin</option>
        </select>
        
        <button onclick="calc();">Calculate Exchange Rate</button>
        <a href="after_login.php" id="k2">Exit</a>
        </div>
